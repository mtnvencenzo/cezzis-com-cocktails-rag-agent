...
# @pytest.fixture
# def mock_consumer(mocker: MockerFixture) -> Mock:
...
# @pytest.fixture
# def reset_app_globals(mocker: MockerFixture) -> Generator[None, None, None]:
...
#     def test_signal_handler_sets_shutdown_flag(self, reset_app_globals: Any) -> None:
...
#     def test_signal_handler_with_different_signals(
#         self, reset_app_globals: Any
#     ) -> None:
...
#     def test_cleanup_with_no_consumer(
#         self, reset_app_globals: Any, capsys: Any
#     ) -> None:
...
#     def test_cleanup_commits_and_closes_consumer(
#         self, reset_app_globals: Any, capsys: Any
#     ) -> None:
...
#     def test_cleanup_handles_commit_error(
#         self, reset_app_globals: Any, capsys: Any
#     ) -> None:
...
#         mocker.patch("app.signal.signal")
#         mocker.patch("app.Consumer", side_effect=Exception("Connection failed"))
...
#         def poll_side_effect(timeout: float) -> Mock | None:
#             nonlocal call_count
#             call_count += 1
#             if call_count == 1:
#                 return mock_msg
...
#     def test_atexit_registers_cleanup(self, mocker: MockerFixture) -> None:
#         """Test that atexit.register is called with cleanup function."""
#         mocker.patch("atexit.register")
#         mocker.patch("app.main")
