...
class TestExtractionAgentAppSettings:
    """Test suite for ExtractionAgentAppSettings configuration."""
    ...
    def test_settings_with_env_file(
        ...
        try:
            from .ext_agent_app_options import ExtractionAgentAppOptions

            settings = ExtractionAgentAppOptions()
    ...
    def test_settings_model_config(
        ...
        assert ExtractionAgentAppOptions.model_config is not None
        assert "env_file" in ExtractionAgentAppOptions.model_config
        assert ExtractionAgentAppOptions.model_config.get("env_file_encoding") == "utf-8"
