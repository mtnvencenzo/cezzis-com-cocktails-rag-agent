md_converter_sys_prompt = """
    Youe Role:
    You are a expert and understanding cocktail recipes and capable of striping markdown syntax out from recipes written in markdown.
    ...
    4. Do not remove any text or headings unless explictly told to do so. Headings start with #, ##, or ###
