...
class TestAppSettings:
    ...
    def test_settings_loads_from_environment_variables(
        self, mock_env_vars, clear_settings_cache, mocker
    ):
    ...
    def test_settings_raises_error_when_bootstrap_servers_missing(
        self, clear_settings_cache, mocker
    ):
    ...
    def test_settings_with_env_file(self, clear_settings_cache, mocker, tmp_path):
    ...
    def test_settings_field_aliases(self, clear_settings_cache, mocker):
    ...
    def test_settings_prints_success_message(self, mock_env_vars, clear_settings_cache, mocker):
    ...
    def test_settings_model_config(self, mock_env_vars, clear_settings_cache, mocker):
