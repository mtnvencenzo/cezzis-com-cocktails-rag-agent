...
#   filename:  https://api.cezzis.com/prd/cocktails/api-docs/v1/scalar/v1/openapi.json
#   timestamp: 2025-11-09T16:25:15+00:00
...
class AccountCocktailRatingsRs(BaseModel):
    ratings: List[AccountCocktailRatingsModel] = Field(
...
class AccountOwnedProfileRs(BaseModel):
    ...
    favoriteCocktails: List[str] = Field(
...
class CocktailsListModel(BaseModel):
    ...
    rating: float = Field(
        ..., description='The overral rating for the recipe', examples=['3.5']
    )
    ingredients: List[IngredientModel] = Field(
        ..., description='The list of ingredients that make up the cocktail recipe'
    )
...
class CocktailsListRs(BaseModel):
    items: List[CocktailsListModel] = Field(
